...
class ALevel : public sf::Drawable
{
public:
    ...
    virtual bool initialise(sf::RenderWindow& window) = 0;
    ...
    /*Additional Functions to be added for each level as needed*/
...
/*NOTE: These should be removed in a true abstract class with only the minimum required here*/
protected:
